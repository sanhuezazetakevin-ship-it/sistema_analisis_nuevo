...
export const Login: React.FC<LoginProps> = ({ onHome, onDemo }) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setSuccessMsg(`¡Bienvenido, ${response.usuario?.nombre || 'Usuario'}! Redirigiendo...`);
      setMockMode(false); // Conectado a la API Real FastAPI

      setTimeout(() => {
        onDemo(); // Ingresa al Dashboard
      }, 800);
    } catch (err: any) {
        ...
        <div className="login-form-col">
          ...
          <div className="max-w-md w-full mx-auto space-y-6">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h2 className="text-2xl font-bold text-[#172b2a]">Acceso al Sistema</h2>
                <p className="text-xs text-slate-500">Ingrese sus credenciales registradas</p>
              </div>
            </div>
